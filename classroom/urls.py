...
urlpatterns = [
    ...
    path('task-submission/file/<int:task_submission_id>', views.TaskSubmissionFileView.as_view(), name='task-submission-file'),
    ...
    path('<int:clas_id>/materials/<int:material_id>/delete', views.DeleteMaterialView.as_view(), name='delete-material'),
    ...
    path('<int:clas_id>/tasks/<int:task_id>/delete', views.DeleteTaskView.as_view(), name='delete-task'),
